    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="login-form">
            ...
            <select class="form-select" id="roleLogin" name="role" required>
            ...
            <div class="red">Invalid email or password.</div>
            </div>
            <div class="mb-3">
            ...
            <input class="login-submit btn btn-primary w-100" type="submit" name ="LoginSubmit" id ="LoginSubmit" value="Log In"/>
        </div>
        </div></form>
...
_END;
    ...
    function CreateUserAccount($connection, $uname, $password) {
        ...
        $query = "INSERT INTO USER_LOGIN (UNAME, PASSWORD_HASHED, SALT1, SALT2) VALUES ('$un', '$token', '$salt1', '$salt2');";
    ...
    function CreateVendorAccount($connection, $uname, $password) {
        ...
        $salt2 = rand();
        $token = hash('ripemd128', "$salt1$pw$salt2");
        $query = "INSERT INTO VENDOR_LOGIN (UNAME, PASSWORD_HASHED, SALT1, SALT2) VALUES ('$un', '$token', '$salt1', '$salt2');";
        if(!mysqli_query($connection, $query)) echo ("<p>Error creating account data.</p>");
    }
